      ...
      <div className="costume_container">
        ...
        <div className="wrapper_description">
          <Row style={{ height: "100%" }}>
            <Col span={16} style={{ paddingRight: "0.25rem", height: "100%" }}>
              <div className="desc_col_left">
                <div className="desc_col_left_title">Mô tả</div>
                <div
                  className="see-more"
            ...
            >
              ...
              >
                ...
                <Row className="table-header">
                  <Col span={5} className="table-header-col">
                    Loại sản phẩm
                  </Col>
                  ...
                  <Col span={3} className="table-header-col">
                    Số lượng
                  </Col>
                  <Col span={4} className="table-header-col">
                    Đơn giá cho thuê
                ...
                <Row className="table-row">
                  <Col span={5} className="table-col-first">
                    <img
                      src={imgPost}
                      style={{ width: "100%", marginBottom: "20px" }}
                    />
                    <div className="text-medium-se">Váy cưới mã 01</div>
                    {/* <div
                  ...
                  <Col span={3} className="table-col">
